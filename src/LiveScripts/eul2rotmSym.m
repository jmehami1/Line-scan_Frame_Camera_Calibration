function R = eul2rotmSym( eul, seq )
%This is the MATLAB script used for converting euler angles to a rotation
%matrix, but it has been edited to work with symbolic variables.
%Editor: Jasprabhjit Mehami, 13446277

%EUL2ROTM Convert Euler angles to rotation matrix for symbolic variables
